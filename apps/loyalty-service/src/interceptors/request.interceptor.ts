...
import type { LoyaltyRequestMetadata, LoyaltyRequestPayload } from '../common';
import { PrismaService } from '../prisma/prisma.service';
import { LoyaltyQueueService } from '../queue/loyalty-queue.service';

const SERVICE_NAME = 'loyalty-service';

type RequestPayload = Partial<LoyaltyRequestPayload<unknown>> & {
...
export class RequestInterceptor implements NestInterceptor {
  ...
  constructor(
    ...
    private readonly loyaltyQueueService: LoyaltyQueueService,
  ) {}
  ...
  private async finalizeRequestLog(
    ...
    try {
      ...
      await this.loyaltyQueueService.enqueueRequestUpdate({
