...
import {
  Prisma,
  RequestStatus,
} from 'libs/prisma/generated/notification-service/client';
...
type RequestPayload = Partial<NotificationRequestPayload<unknown>> & {
...
export class RequestInterceptor implements NestInterceptor {
  ...
  private async finalizeRequestLog(
    ...
    try {
      ...
      await this.notificationQueueService.enqueueRequestUpdate({
