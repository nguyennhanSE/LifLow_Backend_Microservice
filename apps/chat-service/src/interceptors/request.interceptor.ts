...
export class RequestInterceptor implements NestInterceptor {
  ...
  private async finalizeRequestLog(
    ...
    try {
      ...
      await this.chatQueueService.enqueueRequestUpdate({
