...
import type {
  NutritionRequestMetadata,
  NutritionRequestPayload,
} from '../common';
import { PrismaService } from '../prisma/prisma.service';
import { NutritionQueueService } from '../queue/nutrition-queue.service';

const SERVICE_NAME = 'nutrition-service';

type RequestPayload = Partial<NutritionRequestPayload<unknown>> & {
...
export class RequestInterceptor implements NestInterceptor {
  ...
  constructor(
    ...
    private readonly nutritionQueueService: NutritionQueueService,
  ) {}
  ...
  private async finalizeRequestLog(
    ...
    try {
      ...
      await this.nutritionQueueService.enqueueRequestUpdate({
